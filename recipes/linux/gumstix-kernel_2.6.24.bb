...
SRC_URI = "${KERNELORG_MIRROR}/pub/linux/kernel/v2.6/linux-${PV}.tar.bz2 \
       ...
       file://pxa2xx_gumstix_korebot2.patch;patch=1 \
       file://libertas_2.6.25.7.tar.bz2 \
       file://pxa27x_BT.patch;patch=1"



do_configure_prepend() {
	   #remove wireless libertas 2.6.24 and add new libertas drivers
	   echo remove ${WORKDIR}/linux-${PV}/drivers/net/wireless/libertas 	 
	   rm -r -f ${WORKDIR}/linux-${PV}/drivers/net/wireless/libertas 	
	   mv ${WORKDIR}/libertas ${S}/drivers/net/wireless/			
